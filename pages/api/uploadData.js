...
async function storeDataInBlockchain(actualFileName, uniqueFileName) {
    ...
    const StorageContract = new ethers.Contract(Constants.CONTRACT_ADDRESS, Constants.contractAbi, signer);
    ...
    if (isStored == false) {
        const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweDExRUQwYTFEMUM0ZDNmYTA3ZGZDNTY2RTAyN0ZGMGM5NzkwQTZGOTciLCJpc3MiOiJ3ZWIzLXN0b3JhZ2UiLCJpYXQiOjE2OTQyMzg3NDkwNzEsIm5hbWUiOiJpcGZzLWJsb2NrY2hhaW4ifQ.IZYb3l8Zfsm8O9dQjQZN9oz6WV3cqfX9N2fCQlWj5vc";
        ...
        return { message: `IPFS hash is stored in the smart contract: https://${storedhash}.ipfs.w3s.link/` }
    }
